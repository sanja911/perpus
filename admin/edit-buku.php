...
<?php } ?>
                ...
                <section class="content">
                    ...
                    <?php
                    $query = mysqli_query($koneksi,"SELECT * FROM data_buku WHERE id='$_GET[kd]'");
                      ...
                      <form class="form-horizontal style-form" style="margin-top: 20px;" action="update-buku.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  ...
                                  <input name="nama_file" id="nama_file" type="file" accept=".jpg" />
                              </div>
                          </div>
              ...
              <!-- row end -->
                ...
                <div class="footer-main">
                    Copyright &copy <a href="http://www.hakkoblogs.com" target="_blank">Perpustakaan SMKN 5 Malang</a> 2020
                </div>
            </aside><!-- /.right-side -->
