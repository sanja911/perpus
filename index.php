...
tanggallengkap = namahari[hari] + ", " +tanggal + " " + namabulan[bulan] + " " + tahun;
    ...
    <!-- WARNING: Respond.js doesn't work if you view the page via file:// -->
      ...
      <body class="skin-black">
		...
		<b>Selamat Datang di Perpustakaan Online SMKN 5 Malang<!-- PusWeb (Perpustakaan Berbasis Website) Pro Version, Untuk Login Admin silahkan klik Icon User atau klik <a href="login.html">disini</a> --></b>
          </div>
            </div>
              ...
              ?>
                    ...
                    ?>
                  <center>umlah Pengunjung Hari Ini : <?php echo "$user"; ?> Orang </center>
              ...
              <section class="panel">
                            ...
                            <div class="panel-body table-responsive">
                            <?php
                    $query="select * from pengunjung ORDER BY tgl_kunjung AND jam_kunjung DESC";
                    $tampil=mysqli_query($koneksi,$query) or die(mysqli_error());
                    ?>
                                <table id="dataakumulasi" class="table table-striped table-bordered display">
                                  <thead>
                                    <tr>
                                        <th>Nama</th>
                                        <th>Jenis Kelamin</th>
                    ...
                    <div class="twt-area">
                        <form class="form-horizontal style-form" style="margin-top: 20px;" action="insert-pengunjung.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input name="jam_kunjung" type="text" class="form-control" id="jam_kunjung" value="<?php date_default_timezone_set('Asia/Jakarta'); echo "".date("H:i:s").""?>" readonly="readonly"/>
                              </div>
                          </div>
...
<!-- Data Total Pengunjung -->                        
                        <div class="col-md-12">
                            ...
                            <div class="panel-body table-responsive">
                            <?php
                    $query="select * from data_buku ORDER BY judul ASC";
                    $tampil=mysqli_query($koneksi,$query) or die(mysqli_error());
                    ?>
                                <table id="databuku" class="table table-striped table-bordered display">
                                  <thead>
                                    <tr>
                                        <th>Judul</th>
                                        <th>Pengarang</th>
                    ...
                    <tbody>
                    <tr>
                    <td><?php echo $data1['judul']; ?> (<?php echo $data['th_terbit'] ?>)</td>
                    <td><?php echo $data1['pengarang']; ?></td>
                    <td><?php echo $data1['penerbit'];?></td>
                    <td><?php echo $data1['isbn'];?></td>
                    <td><?php echo $data1['kategori'];?></td>
                    <td><?php echo $data1['kode_klas'];?></td>
                    <td><?php echo $data1['jumlah_buku'];?></td>
                    <td><?php echo $data1['lokasi'];?></td>
                    <td><?php echo $data1['tgl_input'];?></td>
                    <td><?php echo $data1['gambar'];?></td>
                    <?php   
              } 
              ?>
